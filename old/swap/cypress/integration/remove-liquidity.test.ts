describe('Remove Liquidity', () => {
  it('redirects', () => {
    cy.visit('/remove/0xF004D9271f68789B31258068160C7E70949ab8EC-0xF9bA5210F91D0474bd1e1DcDAeC4C58E359AaD85')
    cy.url().should(
      'contain',
      '/remove/0xF004D9271f68789B31258068160C7E70949ab8EC/0xF9bA5210F91D0474bd1e1DcDAeC4C58E359AaD85'
    )
  })
  ...
  it('does not crash if ETH is duplicated', () => {
    cy.visit('/remove/0xF004D9271f68789B31258068160C7E70949ab8EC-0xF004D9271f68789B31258068160C7E70949ab8EC')
    cy.get('#remove-liquidity-tokena-symbol').should('contain.text', 'WETH')
